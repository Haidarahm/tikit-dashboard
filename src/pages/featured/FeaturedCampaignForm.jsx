...
export function FeaturedCampaignForm({
  form,
  logoFileList,
  onLogoChange,
  imagesFileList,
  ...
  return (
    <Form form={form} layout="vertical">
      ...
      <Form.Item label="Main Image" required={!isEdit} tooltip="Upload campaign Main Image">
        <Upload
      ...
      <Form.Item
        ...
        required={!isEdit}
        tooltip="Upload one or more campaign images"
      >
        {isEdit && (
          <>
