...
function SubServices() {
  ...
  useEffect(() => {
    if (servicesPerPage < 1000) setServicesPerPage(1000);
    if (servicesPage !== 1) setServicesPage(1);
    fetchServices();
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [servicesLang]);

  // When service selected, set in sub-services store and fetch
  useEffect(() => {
    if (selectedServiceId) {
      setSubId(selectedServiceId);
      fetchList();
    }
        ...
        <div className="flex items-center gap-2">
          ...
          <Select
            ...
            onChange={(value) => {
              setLang(value);
              setPage(1);
              // reflect to services list for titles
              setServicesLang(value);
            }}
          />
